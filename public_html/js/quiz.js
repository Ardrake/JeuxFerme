...
var questions = [
      ['img/animal_1.jpg', '1', "Vache", "Chien", "Cheval", "Poule", 'son/animal_1.wav']
    
    , ['img/animal_2.jpg', '2', "Lapin", "Cheval", "Cochon", "Vache", 'son/animal_2.wav']
    
    , ['img/animal_3.jpg', '1', "Cochon", "Vache", "Lapin", "Chien", 'son/animal_3.wav']

    , ['img/animal_4.jpg', '4', "Cheval", "Poule", "Chat", "Ane", 'son/animal_4.wav']

    , ['img/animal_5.jpg', '4', "Chien", "Chat", "Poule", "Lapin", 'son/animal_5.wav']

    , ['img/animal_6.jpg', '3', "Chat", "Lapin", "Poule", "Cheval", 'son/animal_6.wav']
...
function NextQuestion(response) {
    ...
    if ((qNo < questions.length) && (response == correctAnswer)) {
        ...
        var snd = new Audio('son/erreur.wav');
        snd.play();
    }
    qNo++;
